...
use Class::Accessor::Lite::Lazy (
    ...
    ro_lazy => [qw/ client api auth channels chat dialog dnd emoji files groups im oauth pins reactions rtm search stars team users /],
);
...
for my $class_name (qw/ api auth channels chat dialog dnd emoji files groups im oauth pins reactions rtm search stars team users /) {
